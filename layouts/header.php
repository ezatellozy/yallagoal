...
<head>
    ...
    <!-- <link rel="stylesheet" href="./assets/css/assest.css"> -->
    <link rel="stylesheet" href="./assets/css/main.css">
    <title>Yallagoal</title>
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link dropdown-toggle" href="matches.php">
                                بطولات
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link dropdown-toggle" href="videos.php">
                                فيديوهات
                            </a>
                            <div class="fullScreenMenu">
                                <div class="container">
